...
if readvalue == "DarkThemeTRUE" or readvalue == "DarkTheme":
    ...
    pass
# creating the data fetching function here.
...
def Process_start():
    ...
    except ValueError as unknown_country:
        print(unknown_country)
        messagebox.showerror("No Country Found", "Please Enter Valid Country Name\nAccording To The Country List")
...
label_text3 = "Get All Covid-19 Data By Country Name"
label_text4 = "Enter The Country Name Below"
...
countryimg = PhotoImage(file = "world.png")
...
robo_label = Label(roboframe, bg = bright_background, fg = bright_sublabels, font = "Times 20 bold italic", text = label_text3)
